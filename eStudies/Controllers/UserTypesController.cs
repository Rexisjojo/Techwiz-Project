...
namespace eStudies.Controllers
{
    public class UserTypesController : Controller
    {
        ...
        public UserTypesController(eStudiesDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserTypes != null ? 
                          ...
                          Problem("Entity set 'eStudiesDbContext.UserType'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'eStudiesDbContext.UserType'  is null.");
            }
            var userType = await _context.UserTypes.FindAsync(id);
            if (userType != null)
            {
